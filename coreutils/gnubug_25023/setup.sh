...
# for AFL argv fuzz
sed -i '856i #include "/home/yuntong/fuzzfix.tmp/thirdparty/AFL/experimental/argv_fuzzing/argv-fuzz-inl.h"' src/pr.c
sed -i '860i AFL_INIT_SET0234("./pr", "/home/yuntong/fuzzfix.tmp/data/coreutils/gnubug_25023/dummy", "-m", "/home/yuntong/fuzzfix.tmp/data/coreutils/gnubug_25023/dummy");' src/pr.c
