...
class Offsets(gdb.Command):
    ...
    def invoke(self, arg, from_tty):
        ...
        # There are two types of class_name: those works by itself, and those needs
        # to be prepended with `struct`. We are not sure which one to use here,
        # so try both of them until success.
        try:
            # look up class_name
